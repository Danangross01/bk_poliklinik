...
// Query pasien sesuai dengan nama dokter
$pasien = query("SELECT
                ...
                INNER JOIN dokter ON daftar_poli.id_dokter = dokter.id
  ...
  <div class="card-body p-0">
    <table class="table">
      ...
      <tbody>
        <?php if (empty($pasien)): ?>
          <tr>
            <td colspan="4" class="text-center">Tidak ada pasien untuk dokter ini</td>
          </tr>
        <?php else: ?>
